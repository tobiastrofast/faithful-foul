...
/*!
 * PhotoSphereViewer.VideoPlugin 5.1.5
...
"use strict";
  ...
  var _PlayPauseEvent = class extends import_core.TypedEvent {
    constructor(playing) {
  ...
  var _VolumeChangeEvent = class extends import_core.TypedEvent {
    constructor(volume) {
  ...
  VolumeChangeEvent.type = "volume-change";
  var _ProgressEvent = class extends import_core.TypedEvent {
  ...
  var _BufferEvent = class extends import_core.TypedEvent {
