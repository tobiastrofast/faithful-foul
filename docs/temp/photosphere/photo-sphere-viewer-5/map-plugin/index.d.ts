...
type UpdatableMapPluginConfig = Omit<MapPluginConfig, 'imageUrl' | 'center' | 'visibleOnLoad' | 'defaultZoom' | 'hotspots'>;
...
declare namespace events {
  export {
    events_SelectHotspot as SelectHotspot,
    events_MapPluginEvents as MapPluginEvents,
  };
}

export { MapHotspot, MapPlugin, MapPluginConfig, ParsedMapPluginConfig, UpdatableMapPluginConfig, events };
