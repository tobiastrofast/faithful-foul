...
declare namespace events {
  export {
    events_ResolutionChangedEvent as ResolutionChangedEvent,
    events_ResolutionPluginEvents as ResolutionPluginEvents,
  };
}

export { Resolution, ResolutionPlugin, ResolutionPluginConfig, events };
